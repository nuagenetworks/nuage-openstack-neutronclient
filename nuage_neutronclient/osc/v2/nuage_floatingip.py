...
class ListNuageFloatingIP(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        group.add_argument(
            '--for-subnet',
            help=_('ID or name of subnet to find available floating ips'))
        group.add_argument(
            '--for-port',
            help=_('ID or name of port to find available floating ips'))
        return parser
...
class ShowNuageFloatingIP(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        return display_columns, utils.get_dict_properties(obj, columns)
